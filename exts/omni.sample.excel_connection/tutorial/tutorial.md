...
From there, code can be removed from this file until yours matches that displayed below: 
...
Next we will build the user interface for the extension. This is done by adding the following code below the definition of `self._window`:
...
### Step 4: Adding the `Win32Com` Dependencies
...
### Step 5: Connecting to the Excel Application
...
### Step 6: Subscribing to Changes from Excel
...
### Step 7: Responding to Changes from Excel
...
### Step 8: Subscribing to Changes from Omniverse
...
### Step 9: Responding to Changes from Omniverse
